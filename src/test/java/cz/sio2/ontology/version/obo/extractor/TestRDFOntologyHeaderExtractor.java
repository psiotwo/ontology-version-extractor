...
import cz.sio2.ontology.version.obo.Extractor;
...
public class TestRDFOntologyHeaderExtractor {
    ...
    public void testExtractVersionFromVersionIriFromRDFXMLWorksCorrectly(String file,
        ...
        final OntologyHeader header = new Extractor().extract(s, HeaderFetcher.ONTOLOGY_HEADER_EXTRACTORS.get("RDFXMLOntologyHeaderExtractor"));
